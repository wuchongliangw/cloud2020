...
public final class RestResponse<T> implements Serializable {
     ...
     * 用户不存在
     */
    public static int CODE_USER_NOT_EXISTS = 8;

    /**
     * token为空或无效的token
     */
    public static int CODE_TOKEN_ERROR = 9;
     ...
     * 用户不存在
     */
    public static String MESSAGE_USER_NOT_EXISTS = "用户不存在";

    /**
     * token为空或无效的token
     */
    public static String MESSAGE_TOKEN_ERROR = "token为空或无效的token";
     ...
     * 用户不存在
     */
    public static <T> RestResponse<T> USER_NOT_EXISTS() {
        return error(CODE_USER_NOT_EXISTS, MESSAGE_USER_NOT_EXISTS);
    }
